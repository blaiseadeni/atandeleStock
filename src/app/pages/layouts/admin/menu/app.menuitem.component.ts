...
import { MenuService } from '../../../../_primeng/services/app.menu.service';
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public appMain: AdminComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
